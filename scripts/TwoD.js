 ...
 *              TwoD.js (1.3)                                              *
 *                                                                         *
 *   Project:  canvas helpful functions for 2d(x,y)                       *
 *                                                                         *
 *   Author:   Andrew Tuček, +420 771 115 994        Y                    *
 *                                                   |                    *
 *   Date:     22.2.2021                       ------|------X             *
 *                                                   |                    *
 *   License:  MIT                                   |                    *
...
class RenderWindow {
	...
	Create() {
		...
		this.canvas.innerHTML =
			'Your browser is not capable of HTML5, please upgrade for full experience,otherwise enjoy black screen ;)';
...
window.addEventListener('keydown', (e) => {
	...
	if (keyPressed == 27) {
		escapePressed ? (escapePressed = false) : (escapePressed = true);
	}
});
