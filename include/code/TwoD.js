const Area = {
    ...
    create: function (w, h, zIndex, color) {
        ...
        this.area.innerHTML = "your browser does not support HTML5, please upgrade first!";
...
const draw = {
    ...
    UI: function (ctx, x1, y1, w1, h1, color1, content, font, x2, y2, size, lenght, color2) {
        this.rect(ctx, x1, y1, w1, h1, color1);
        font == "" ? (font = "Georgia") : this.text(ctx, content, font, x1 + x2, y1 + y2, size, lenght, color2);
    },
};
let keyboard = { w: 87, s: 83, a: 65, d: 68, up: 38, right: 39, left: 37, down: 40, space: 32, enter: 13 },
...
window.addEventListener("keydown", (e) => {
    ...
    if (keyPressed == 105 || enterPressed) showFPS ? (showFPS = false) : (showFPS = true);
});
